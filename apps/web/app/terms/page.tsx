      ...
      <main id="main-content" className="max-w-4xl mx-auto px-6 py-16 sm:py-24">
        ...
        <header className="mb-16 space-y-6">
          ...
          <p className="text-gray-400 text-base leading-relaxed max-w-2xl">
            ...
            <strong className="text-white">nexvideo</strong>. Ao criar uma conta ou utilizar
            nossos serviços, você concorda com estes Termos na sua totalidade. Leia com atenção
            antes de prosseguir.
          </p>
          <div className="flex flex-wrap gap-6 text-sm text-gray-500">
            <p>
              Versão:{" "}
              <span className="text-gray-400 font-medium">{CURRENT_VERSION}</span>
            </p>
            <p>
              Última atualização:{" "}
              <time dateTime={LAST_UPDATED_ISO} className="text-gray-400 font-medium">
                {LAST_UPDATED}
              </time>
            </p>
          </div>
        ...
        <div className="space-y-16 text-gray-300 leading-relaxed">
          ...
          <section id="acceptance">
            ...
            <p className="mb-4">
              Ao acessar ou usar a plataforma nexvideo, você declara que leu, compreendeu e
              concorda em ficar vinculado a estes Termos de Uso e à nossa{" "}
              <Link href="/privacy" className="text-[#7C3AED] hover:text-[#a78bfa] transition-colors underline">
                Política de Privacidade
              </Link>
              , que é incorporada a estes Termos por referência.
            </p>
            <p>
              Se você está aceitando estes Termos em nome de uma organização, você declara ter
              autoridade legal para vinculá-la. Se não concordar com qualquer parte destes Termos,
              você não está autorizado a usar nosso serviço.
            </p>
          </section>
          ...
          <section id="service">
            ...
            <p className="mb-4">
              A nexvideo é uma plataforma SaaS de produção de conteúdo com inteligência artificial,
              que oferece:
            </p>
            ...
            <p>
              ...
              do serviço a qualquer momento, com aviso prévio razoável quando materialmente relevante.
            </p>
          </section>

          {/* 3. Conta */}
          <section id="account">
            <SectionHeading number="3">Elegibilidade e Conta de Usuário</SectionHeading>
            <p className="mb-4">
              Para usar a nexvideo você deve:
            </p>
            <ul className="space-y-3 list-none pl-0 mb-6">
              {[
            ...
            <p className="mb-4">
              Você é responsável por manter a confidencialidade das suas credenciais e por toda a
              atividade realizada na sua conta. Notifique-nos imediatamente em caso de uso não
              autorizado em{" "}
              <a
            ...
            <p>
              Cada conta está vinculada a uma organização. Os limites de uso dependem do plano
              contratado e são aplicados por organização.
            </p>
          </section>
          ...
          <section id="billing">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-white font-semibold mb-2">Planos e Cobrança</h3>
                <p>
                  A nexvideo oferece planos de assinatura mensais e anuais. Os preços são exibidos
                  em BRL (Real Brasileiro) e incluem os impostos aplicáveis. O faturamento é
                  processado via{" "}
                  <strong className="text-white">Stripe</strong> e ocorre automaticamente no início
                  de cada ciclo de cobrança.
                </p>
              </div>
              <div>
                <h3 className="text-white font-semibold mb-2">Plano Gratuito</h3>
                <p>
                  O plano gratuito está sujeito a limites de uso definidos na página de preços.
                  Funcionalidades premium não estão disponíveis no plano gratuito.
                </p>
              </div>
              <div>
                <h3 className="text-white font-semibold mb-2">Cancelamento</h3>
                <p>
                  Você pode cancelar sua assinatura a qualquer momento pelo painel da conta. O
                  acesso ao plano pago permanece ativo até o fim do período já pago. Não há
                  reembolso proporcional por período não utilizado, salvo exigência legal aplicável.
                </p>
              </div>
              <div>
                <h3 className="text-white font-semibold mb-2">Falha de Pagamento</h3>
                <p>
                  Em caso de falha no pagamento, o plano será rebaixado para o tier gratuito após
                  um período de carência de 7 dias. Dados e projetos são retidos por 90 dias após
                  o cancelamento.
                </p>
              </div>
            </div>
          ...
          <section id="acceptable-use">
            ...
            <p className="mt-6">
              Violações desta seção podem resultar em suspensão ou encerramento imediato da conta,
          ...
          <section id="user-content">
            ...
            <p className="mb-4">
              <strong className="text-white">Conteúdo gerado por IA:</strong> os roteiros, títulos e
              narrações produzidos pela plataforma são gerados com base nos seus inputs e na nossa
              infraestrutura de IA. Você é responsável por revisar, editar e verificar a precisão de
              qualquer conteúdo antes de publicá-lo.
            </p>
            <p>
              Não utilizamos seu Conteúdo para treinar modelos de IA de terceiros sem seu
          ...
          <section id="ip">
            ...
            <p className="mb-4">
              A plataforma nexvideo, incluindo seu código-fonte, design, marcas, logotipos,
              interfaces e documentação, é de propriedade exclusiva da nexvideo ou de seus
              licenciantes, protegida pelas leis de propriedade intelectual aplicáveis.
            </p>
            <p>
              Estes Termos não transferem nenhum direito de propriedade intelectual. Qualquer uso
              não autorizado da nossa propriedade intelectual é expressamente proibido e pode
              resultar em medidas legais.
            </p>
          </section>
          ...
          <section id="third-party">
            ...
            <p className="mb-4">
              A nexvideo integra-se a serviços de terceiros (YouTube, Stripe, OpenAI, entre outros).
              O uso dessas integrações está sujeito aos termos e políticas de privacidade dos
              respectivos provedores.
            </p>
            <p className="mb-4">
              <strong className="text-white">Integração YouTube:</strong> ao conectar sua conta
              YouTube, você autoriza expressamente a nexvideo a acessar os scopes selecionados
              (leitura de canal, upload, analytics) conforme descrito durante o fluxo de autorização
              OAuth. Você pode revogar essa autorização a qualquer momento pelo painel da conta ou
              diretamente em{" "}
              <a
            ...
            <p>
              Não somos responsáveis por interrupções, alterações de API ou mudanças de política
          ...
          <section id="liability">
            <SectionHeading number="9">Limitação de Responsabilidade</SectionHeading>
            <p className="mb-4 text-sm uppercase tracking-wider text-gray-500 font-semibold">
              Leia com atenção
            </p>
            <p className="mb-4">
              Na máxima extensão permitida pela lei aplicável, a nexvideo e seus colaboradores,
              diretores e parceiros não serão responsáveis por danos indiretos, incidentais,
              especiais, consequenciais ou punitivos, incluindo perda de lucros, dados ou boa vontade,
              decorrentes de ou relacionados ao uso do serviço.
            </p>
            <p className="mb-4">
              A responsabilidade total da nexvideo perante você, por qualquer causa, não excederá o
              valor que você pagou pelo serviço nos{" "}
              <strong className="text-white">12 meses anteriores</strong> ao evento que deu origem
              à reclamação, ou R$&nbsp;100,00, o que for maior.
            </p>
            <p>
              O serviço é fornecido &quot;como está&quot; e &quot;conforme disponível&quot;, sem
              garantias de qualquer natureza, expressas ou implícitas. Não garantimos que o serviço
              será ininterrupto, livre de erros ou que os resultados gerados por IA serão precisos.
            </p>
          </section>
          ...
          <section id="termination">
            ...
            <p>
              Após o encerramento, seus dados serão retidos por 90 dias para fins de recuperação,
              após os quais serão permanentemente excluídos, exceto quando a retenção for exigida
              por lei (ex.: dados fiscais, conforme seção de retenção da Política de Privacidade).
            </p>
          </section>
          ...
          <section id="changes">
            ...
            <p className="mb-4">
              ...
              notificadas por e-mail ou por aviso em destaque na plataforma com pelo menos{" "}
              <strong className="text-white">15 dias de antecedência</strong>. Alterações não
              materiais (correções gramaticais, reformatação) podem ser feitas sem aviso prévio.
            </p>
            <p>
              O uso continuado da plataforma após a data de vigência das alterações constitui
              aceitação dos Termos atualizados. O número de versão e a data são sempre exibidos
              no topo desta página. Versões anteriores estão disponíveis no{" "}
              <a href="#version-history" className="text-[#7C3AED] hover:text-[#a78bfa] transition-colors underline">
              ...
              <table className="w-full text-sm" role="table">
                <thead>
                  <tr className="border-b border-gray-800/50 bg-gray-900/50">
                    <th scope="col" className="px-4 py-3 text-left text-gray-400 font-medium w-24">
                      Versão
                    </th>
                    <th scope="col" className="px-4 py-3 text-left text-gray-400 font-medium w-40">
                      Data
                    </th>
                ...
                <tbody>
                  <tr className="border-b border-gray-800/30 last:border-0">
                    ...
                    <td className="px-4 py-3 text-gray-400 align-top">
                      Versão inicial publicada. Cobre aceitação, serviço, conta, faturamento, uso
                      aceitável, conteúdo, propriedade intelectual, integrações, responsabilidade,
          ...
          <section id="contact">
            ...
            <p className="mb-6">
              Para dúvidas sobre estes Termos ou questões jurídicas relacionadas ao serviço:
            </p>
            <div className="p-6 rounded-xl border border-gray-800/50 bg-gray-900/30 space-y-4">
              ...
              <div>
                <p className="text-sm text-gray-500 mb-1">Lei aplicável e foro</p>
                <p className="text-white">
                  Estes Termos são regidos pelas leis da República Federativa do Brasil. Fica eleito
                  o foro da Comarca de São Paulo/SP para dirimir quaisquer controvérsias oriundas
                  destes Termos, com renúncia expressa a qualquer outro, por mais privilegiado que
                  seja.
                </p>
              </div>
            </div>
            ...
            <p className="mt-6 p-4 rounded-lg border border-amber-800/30 bg-amber-900/10 text-sm text-amber-300/80">
              <strong className="text-amber-200">Recomendação jurídica:</strong> este documento é
              um template elaborado com base nas melhores práticas para SaaS no Brasil. Recomenda-se
              revisão por advogado especializado antes do lançamento em produção.
            </p>
          </section>
